	...
	! per unit mass(from thermal noise),
  	...
  	!----------------------------------------------------
        ...
        IF ( this%Brownian .AND. &
           ...
           IF ( f_d > 0.0_MK) THEN
              PRINT *, "rhs_force_ff_non_Newtnonian_HuAdams : ",&
...
9999    CONTINUE
      ...
      END SUBROUTINE rhs_force_ff_non_Newtonian_HuAdams
