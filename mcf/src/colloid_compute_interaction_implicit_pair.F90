      SUBROUTINE colloid_compute_interaction_implicit_pair(this,&
           ...
           DO i = 1, num - 1
              ...
              DO j = i + 1, num
                 ...
                 IF ( h < hn_l ) THEN
                    ...
                    F_lub(1:dim,j) = F_lub(1:dim,j) - Aij * eij(1:dim)
           ...
           DO i = 1, num - 1
              ...
              DO j = i + 1, num
                 ...
                 IF ( h < hn_l ) THEN
                    ...
                    !----------------------------------------
                    ! dt_s/2/m is coefficient of Aij.
                    ! Assuming now mi=mj
                    !----------------------------------------
                    ...
                    Aij = -0.5_MK * this%eta * &
                         ( (aa/h)**1.5_MK  * (F0 + h*F1/aa) -&
                         (aa/hn_l)**1.5_MK * (F0 + hn_l*F1/aa) ) * &
                         0.5_MK * dt_s / this%m(i)
                    
                    !-------------------------------------------
                    ! Solve 2*2 linear system analytically.
                    !-------------------------------------------

#include "velocity_backward_Euler_2d.inc"
...
9999    CONTINUE
      ...
      END SUBROUTINE colloid_compute_interaction_implicit_pair
