...
/* Generated on Sat Oct  4 10:26:27 EDT 2008 */
...
static const R *t2fv_32(R *ri, R *ii, const R *W, stride ios, INT m, INT dist)
{
     ...
     for (i = m; i > 0; i = i - VL, x = x + (VL * dist), W = W + (TWVL * 62), MAKE_VOLATILE_STRIDE(ios)) {
			 ...
			 }
			 {
			      ...
			      T3p = VADD(T3j, T3i);
			      {
				   ...
				   T3m = VFMA(LDK(KP923879532), T3d, T36);
				   {
					...
					ST(&(x[WS(ios, 24)]), VFNMSI(T31, T30), dist, &(x[0]));
					ST(&(x[WS(ios, 8)]), VFMAI(T31, T30), dist, &(x[0]));
			      ...
			      T1E = VSUB(T1C, T1D);
			      {
				   ...
				   ST(&(x[WS(ios, 23)]), VFMAI(T1R, T1O), dist, &(x[WS(ios, 1)]));
				   ST(&(x[WS(ios, 9)]), VFNMSI(T1R, T1O), dist, &(x[WS(ios, 1)]));
				   ST(&(x[WS(ios, 25)]), VFNMSI(T1T, T1S), dist, &(x[WS(ios, 1)]));
				   ST(&(x[WS(ios, 7)]), VFMAI(T1T, T1S), dist, &(x[WS(ios, 1)]));
				   ST(&(x[WS(ios, 31)]), VFMAI(T1L, T1K), dist, &(x[WS(ios, 1)]));
				   ST(&(x[WS(ios, 1)]), VFNMSI(T1L, T1K), dist, &(x[WS(ios, 1)]));
				   ST(&(x[WS(ios, 15)]), VFMAI(T1J, T1u), dist, &(x[WS(ios, 1)]));
				   ST(&(x[WS(ios, 17)]), VFNMSI(T1J, T1u), dist, &(x[WS(ios, 1)]));
			      }
	  ...
	  }
	  {
	       ...
	       T27 = VFMA(LDK(KP923879532), T26, T25);
	       {
		    ...
		    ST(&(x[WS(ios, 21)]), VFNMSI(T2j, T2g), dist, &(x[WS(ios, 1)]));
		    ST(&(x[WS(ios, 11)]), VFMAI(T2j, T2g), dist, &(x[WS(ios, 1)]));
		    ST(&(x[WS(ios, 27)]), VFMAI(T2l, T2k), dist, &(x[WS(ios, 1)]));
		    ST(&(x[WS(ios, 5)]), VFNMSI(T2l, T2k), dist, &(x[WS(ios, 1)]));
		    ST(&(x[WS(ios, 3)]), VFMAI(T2d, T2c), dist, &(x[WS(ios, 1)]));
		    ST(&(x[WS(ios, 29)]), VFNMSI(T2d, T2c), dist, &(x[WS(ios, 1)]));
		    ST(&(x[WS(ios, 19)]), VFMAI(T2b, T24), dist, &(x[WS(ios, 1)]));
		    ST(&(x[WS(ios, 13)]), VFNMSI(T2b, T24), dist, &(x[WS(ios, 1)]));
	       }
	  }
     }
     return W;
