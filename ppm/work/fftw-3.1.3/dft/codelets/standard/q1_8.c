...
/* Generated on Sat Oct  4 10:22:09 EDT 2008 */
...
static const R *q1_8(R *rio, R *iio, const R *W, stride is, stride vs, INT m, INT dist)
{
     ...
     INT i;
     for (i = m; i > 0; i = i - 1, rio = rio + dist, iio = iio + dist, W = W + 14, MAKE_VOLATILE_STRIDE(is), MAKE_VOLATILE_STRIDE(vs)) {
			      ...
			      E T4C, T57, T4B, T5E, T4R, T4D, T58, T59;
			      {
				   ...
				   }
				   {
					...
					T4z = rio[WS(vs, 3)];
					{
					     ...
					     TQ = Tz + TC;
					     TD = Tz - TC;
					     T4A = rio[WS(vs, 3) + WS(is, 4)];
					}
					T4P = iio[WS(vs, 3)];
					T4Q = iio[WS(vs, 3) + WS(is, 4)];
					T4C = rio[WS(vs, 3) + WS(is, 2)];
					T57 = T4z - T4A;
					T4B = T4z + T4A;
					T5E = T4P + T4Q;
					T4R = T4P - T4Q;
					T4D = rio[WS(vs, 3) + WS(is, 6)];
					T58 = iio[WS(vs, 3) + WS(is, 2)];
					T59 = iio[WS(vs, 3) + WS(is, 6)];
				   }
			      }
			      {
				   E T68, T6D, T67, T7a, T6n, T69, T6E, T6F;
				   {
					...
					T65 = rio[WS(vs, 4)];
					{
					     ...
					     T5o = T57 + T5a;
					     T5b = T57 - T5a;
					     T66 = rio[WS(vs, 4) + WS(is, 4)];
					}
					T6l = iio[WS(vs, 4)];
					T6m = iio[WS(vs, 4) + WS(is, 4)];
					T68 = rio[WS(vs, 4) + WS(is, 2)];
					T6D = T65 - T66;
					T67 = T65 + T66;
					T7a = T6l + T6m;
					T6n = T6l - T6m;
					T69 = rio[WS(vs, 4) + WS(is, 6)];
					T6E = iio[WS(vs, 4) + WS(is, 2)];
					T6F = iio[WS(vs, 4) + WS(is, 6)];
				   }
				   {
					E TaD, TaE, TaT, TaU;
					TaD = rio[WS(vs, 7)];
					{
					     ...
					     T6U = T6D + T6G;
					     T6H = T6D - T6G;
					     TaE = rio[WS(vs, 7) + WS(is, 4)];
					}
					TaT = iio[WS(vs, 7)];
					TaU = iio[WS(vs, 7) + WS(is, 4)];
					TaG = rio[WS(vs, 7) + WS(is, 2)];
					Tbb = TaD - TaE;
					TaF = TaD + TaE;
					TbI = TaT + TaU;
					TaV = TaT - TaU;
					TaH = rio[WS(vs, 7) + WS(is, 6)];
					Tbc = iio[WS(vs, 7) + WS(is, 2)];
					Tbd = iio[WS(vs, 7) + WS(is, 6)];
				   }
			      }
			 }
			 {
			      E T36, T3B, T35, T48, T3l, T37, T3C, T3D;
			      {
				   E T1A, T25, T1z, T2C, T1P, T1B, T26, T27;
				   {
					...
					T1x = rio[WS(vs, 1)];
					{
					     ...
					     Tbs = Tbb + Tbe;
					     Tbf = Tbb - Tbe;
					     T1y = rio[WS(vs, 1) + WS(is, 4)];
					}
					T1N = iio[WS(vs, 1)];
					T1O = iio[WS(vs, 1) + WS(is, 4)];
					T1A = rio[WS(vs, 1) + WS(is, 2)];
					T25 = T1x - T1y;
					T1z = T1x + T1y;
					T2C = T1N + T1O;
					T1P = T1N - T1O;
					T1B = rio[WS(vs, 1) + WS(is, 6)];
					T26 = iio[WS(vs, 1) + WS(is, 2)];
					T27 = iio[WS(vs, 1) + WS(is, 6)];
				   }
				   {
					E T33, T34, T3j, T3k;
					T33 = rio[WS(vs, 2)];
					{
					     ...
					     T2m = T25 + T28;
					     T29 = T25 - T28;
					     T34 = rio[WS(vs, 2) + WS(is, 4)];
					}
					T3j = iio[WS(vs, 2)];
					T3k = iio[WS(vs, 2) + WS(is, 4)];
					T36 = rio[WS(vs, 2) + WS(is, 2)];
					T3B = T33 - T34;
					T35 = T33 + T34;
					T48 = T3j + T3k;
					T3l = T3j - T3k;
					T37 = rio[WS(vs, 2) + WS(is, 6)];
					T3C = iio[WS(vs, 2) + WS(is, 2)];
					T3D = iio[WS(vs, 2) + WS(is, 6)];
				   }
			      }
			      {
				   E T7E, T89, T7D, T8G, T7T, T7F, T8a, T8b;
				   {
					...
					T7B = rio[WS(vs, 5)];
					{
					     ...
					     T3S = T3B + T3E;
					     T3F = T3B - T3E;
					     T7C = rio[WS(vs, 5) + WS(is, 4)];
					}
					T7R = iio[WS(vs, 5)];
					T7S = iio[WS(vs, 5) + WS(is, 4)];
					T7E = rio[WS(vs, 5) + WS(is, 2)];
					T89 = T7B - T7C;
					T7D = T7B + T7C;
					T8G = T7R + T7S;
					T7T = T7R - T7S;
					T7F = rio[WS(vs, 5) + WS(is, 6)];
					T8a = iio[WS(vs, 5) + WS(is, 2)];
					T8b = iio[WS(vs, 5) + WS(is, 6)];
				   }
				   {
					E T97, T98, T9n, T9o;
					T97 = rio[WS(vs, 6)];
					{
					     ...
					     T8q = T89 + T8c;
					     T8d = T89 - T8c;
					     T98 = rio[WS(vs, 6) + WS(is, 4)];
					}
					T9n = iio[WS(vs, 6)];
					T9o = iio[WS(vs, 6) + WS(is, 4)];
					T9a = rio[WS(vs, 6) + WS(is, 2)];
					T9F = T97 - T98;
					T99 = T97 + T98;
					Tac = T9n + T9o;
					T9p = T9n - T9o;
					T9b = rio[WS(vs, 6) + WS(is, 6)];
					T9G = iio[WS(vs, 6) + WS(is, 2)];
					T9H = iio[WS(vs, 6) + WS(is, 6)];
				   }
			      }
			 }
		    }
			      ...
			      E T5M, T4T, T5c, T52, T5N, T4W;
			      {
				   ...
				   }
				   {
					E T4I, T4Y, T4U, T51, T4L, T4V;
					{
					     ...
					     T4G = rio[WS(vs, 3) + WS(is, 1)];
					     T4H = rio[WS(vs, 3) + WS(is, 5)];
					     Tv = Tp - Tu;
					     TR = Tu + Tp;
					     TG = TE - TF;
					     TW = TE + TF;
					     T4I = T4G + T4H;
					     T4Y = T4G - T4H;
					     T4Z = iio[WS(vs, 3) + WS(is, 1)];
					     T50 = iio[WS(vs, 3) + WS(is, 5)];
					     T4J = rio[WS(vs, 3) + WS(is, 7)];
					     T4K = rio[WS(vs, 3) + WS(is, 3)];
					     T4U = iio[WS(vs, 3) + WS(is, 7)];
					     T51 = T4Z - T50;
					     T5M = T4Z + T50;
					     T4L = T4J + T4K;
					     T4T = T4J - T4K;
					     T4V = iio[WS(vs, 3) + WS(is, 3)];
					}
					T5c = T51 - T4Y;
					T52 = T4Y + T51;
					T5H = T4L - T4I;
			      ...
			      }
			      {
				   E T7i, T6p, T6y, T6I, T6s, T7j;
				   {
					E T6e, T6u, T6q, T6x, T6h, T6r;
					{
					     ...
					     {
						  E T4X, T5d, T6c, T6d;
						  T6c = rio[WS(vs, 4) + WS(is, 1)];
						  T6d = rio[WS(vs, 4) + WS(is, 5)];
						  T5O = T5M - T5N;
						  T62 = T5M + T5N;
						  T4X = T4T - T4W;
						  T5d = T4T + T4W;
						  ...
						  T5u = T5c + T5d;
						  T5e = T5c - T5d;
						  T6v = iio[WS(vs, 4) + WS(is, 1)];
						  T6w = iio[WS(vs, 4) + WS(is, 5)];
					     }
					     T6f = rio[WS(vs, 4) + WS(is, 7)];
					     T6g = rio[WS(vs, 4) + WS(is, 3)];
					     T6q = iio[WS(vs, 4) + WS(is, 7)];
					     T7i = T6v + T6w;
					     T6x = T6v - T6w;
					     T6p = T6f - T6g;
					     T6h = T6f + T6g;
					     T6r = iio[WS(vs, 4) + WS(is, 3)];
					}
					T6y = T6u + T6x;
					T6I = T6x - T6u;
					T6i = T6e + T6h;
				   ...
				   }
				   {
					E Tb2, TaM, TaY, Tb5, TaP, TaZ;
					{
					     ...
					     {
						  E T6J, T6t, TaK, TaL;
						  TaK = rio[WS(vs, 7) + WS(is, 1)];
						  TaL = rio[WS(vs, 7) + WS(is, 5)];
						  T7y = T7i + T7j;
						  T7k = T7i - T7j;
						  T6J = T6p + T6s;
						  T6t = T6p - T6s;
						  ...
						  T6K = T6I - T6J;
						  T70 = T6I + T6J;
						  Tb3 = iio[WS(vs, 7) + WS(is, 1)];
						  Tb4 = iio[WS(vs, 7) + WS(is, 5)];
					     }
					     TaN = rio[WS(vs, 7) + WS(is, 7)];
					     TaO = rio[WS(vs, 7) + WS(is, 3)];
					     TaY = iio[WS(vs, 7) + WS(is, 7)];
					     Tb5 = Tb3 - Tb4;
					     TbQ = Tb3 + Tb4;
					     TaP = TaN + TaO;
					     TaX = TaN - TaO;
					     TaZ = iio[WS(vs, 7) + WS(is, 3)];
					}
					Tbg = Tb5 - Tb2;
					Tb6 = Tb2 + Tb5;
					TbL = TaP - TaM;
			      ...
			      E T4g, T3n, T3G, T3w, T4h, T3q;
			      {
				   E T2K, T1R, T20, T2a, T1U, T2L;
				   {
					E T1G, T1W, T1S, T1Z, T1J, T1T;
					{
					     ...
					     {
						  E Tb1, Tbh, T1E, T1F;
						  T1E = rio[WS(vs, 1) + WS(is, 1)];
						  T1F = rio[WS(vs, 1) + WS(is, 5)];
						  TbS = TbQ - TbR;
						  Tc6 = TbQ + TbR;
						  Tb1 = TaX - Tb0;
						  Tbh = TaX + Tb0;
						  ...
						  Tby = Tbg + Tbh;
						  Tbi = Tbg - Tbh;
						  T1X = iio[WS(vs, 1) + WS(is, 1)];
						  T1Y = iio[WS(vs, 1) + WS(is, 5)];
					     }
					     T1H = rio[WS(vs, 1) + WS(is, 7)];
					     T1I = rio[WS(vs, 1) + WS(is, 3)];
					     T1S = iio[WS(vs, 1) + WS(is, 7)];
					     T2K = T1X + T1Y;
					     T1Z = T1X - T1Y;
					     T1R = T1H - T1I;
					     T1J = T1H + T1I;
					     T1T = iio[WS(vs, 1) + WS(is, 3)];
					}
					T20 = T1W + T1Z;
					T2a = T1Z - T1W;
					T1K = T1G + T1J;
				   ...
				   }
				   {
					E T3s, T3c, T3o, T3v, T3f, T3p;
					{
					     ...
					     {
						  E T2b, T1V, T3a, T3b;
						  T3a = rio[WS(vs, 2) + WS(is, 1)];
						  T3b = rio[WS(vs, 2) + WS(is, 5)];
						  T30 = T2K + T2L;
						  T2M = T2K - T2L;
						  T2b = T1R + T1U;
						  T1V = T1R - T1U;
						  ...
						  T2c = T2a - T2b;
						  T2s = T2a + T2b;
						  T3t = iio[WS(vs, 2) + WS(is, 1)];
						  T3u = iio[WS(vs, 2) + WS(is, 5)];
					     }
					     T3d = rio[WS(vs, 2) + WS(is, 7)];
					     T3e = rio[WS(vs, 2) + WS(is, 3)];
					     T3o = iio[WS(vs, 2) + WS(is, 7)];
					     T3v = T3t - T3u;
					     T4g = T3t + T3u;
					     T3f = T3d + T3e;
					     T3n = T3d - T3e;
					     T3p = iio[WS(vs, 2) + WS(is, 3)];
					}
					T3G = T3v - T3s;
					T3w = T3s + T3v;
					T4b = T3f - T3c;
			      ...
			      }
			      {
				   E T8O, T7V, T84, T8e, T7Y, T8P;
				   {
					E T7K, T80, T7W, T83, T7N, T7X;
					{
					     ...
					     {
						  E T3r, T3H, T7I, T7J;
						  T7I = rio[WS(vs, 5) + WS(is, 1)];
						  T7J = rio[WS(vs, 5) + WS(is, 5)];
						  T4i = T4g - T4h;
						  T4w = T4g + T4h;
						  T3r = T3n - T3q;
						  T3H = T3n + T3q;
						  ...
						  T3Y = T3G + T3H;
						  T3I = T3G - T3H;
						  T81 = iio[WS(vs, 5) + WS(is, 1)];
						  T82 = iio[WS(vs, 5) + WS(is, 5)];
					     }
					     T7L = rio[WS(vs, 5) + WS(is, 7)];
					     T7M = rio[WS(vs, 5) + WS(is, 3)];
					     T7W = iio[WS(vs, 5) + WS(is, 7)];
					     T8O = T81 + T82;
					     T83 = T81 - T82;
					     T7V = T7L - T7M;
					     T7N = T7L + T7M;
					     T7X = iio[WS(vs, 5) + WS(is, 3)];
					}
					T84 = T80 + T83;
					T8e = T83 - T80;
					T7O = T7K + T7N;
				   ...
				   }
				   {
					E T9w, T9g, T9s, T9z, T9j, T9t;
					{
					     ...
					     {
						  E T8f, T7Z, T9e, T9f;
						  T9e = rio[WS(vs, 6) + WS(is, 1)];
						  T9f = rio[WS(vs, 6) + WS(is, 5)];
						  T94 = T8O + T8P;
						  T8Q = T8O - T8P;
						  T8f = T7V + T7Y;
						  T7Z = T7V - T7Y;
						  ...
						  T8g = T8e - T8f;
						  T8w = T8e + T8f;
						  T9x = iio[WS(vs, 6) + WS(is, 1)];
						  T9y = iio[WS(vs, 6) + WS(is, 5)];
					     }
					     T9h = rio[WS(vs, 6) + WS(is, 7)];
					     T9i = rio[WS(vs, 6) + WS(is, 3)];
					     T9s = iio[WS(vs, 6) + WS(is, 7)];
					     T9z = T9x - T9y;
					     Tak = T9x + T9y;
					     T9j = T9h + T9i;
					     T9r = T9h - T9i;
					     T9t = iio[WS(vs, 6) + WS(is, 3)];
					}
					T9K = T9z - T9w;
					T9A = T9w + T9z;
					Taf = T9j - T9g;
			      ...
			      E T10, T13, T1h, T1a, Tat, Taq, TbC, TbF, TbE, TbG, TbD;
			      {
				   E T1q, T1v, T1s, T1w, T1r;
				   {
					...
					}
					{
					     ...
					     T1k = T19 + T18;
					     T1a = T18 - T19;
					     iio[WS(vs, 6) + WS(is, 1)] = FNMS(T2I, T2N, T2H);
					     rio[WS(vs, 6) + WS(is, 1)] = FMA(T2B, T2N, T2O);
					     T1j = W[2];
					     T1m = W[3];
					     T1q = T7 - Te;
					     T1v = T1t - T1u;
				   ...
				   }
				   {
					E Tc2, Tc7, Tc4, Tc8, Tc3;
					{
					     ...
					     Tc1 = W[6];
					     Tc4 = W[7];
					     iio[WS(vs, 6) + WS(is, 6)] = FNMS(Tai, Tan, Tah);
					     rio[WS(vs, 6) + WS(is, 6)] = FMA(Tab, Tan, Tao);
					     Tc8 = Tc1 * Tc7;
					     Tc3 = Tc1 * Tc2;
					}
					{
					     ...
					     iio[WS(vs, 4) + WS(is, 7)] = FNMS(Tc4, Tc2, Tc8);
					     rio[WS(vs, 4) + WS(is, 7)] = FMA(Tc4, Tc7, Tc3);
					     Tbr = W[8];
					     Tbw = W[9];
					     TbA = Tbr * Tbz;
					     Tbv = Tbr * Tbu;
					     TbB = W[0];
					     TbE = W[1];
					     iio[WS(vs, 5) + WS(is, 7)] = FNMS(Tbw, Tbu, TbA);
					     rio[WS(vs, 5) + WS(is, 7)] = FMA(Tbw, Tbz, Tbv);
					     TbG = TbB * TbF;
					     TbD = TbB * TbC;
					}
				   }
			      }
			      {
				   E T2o, T2t, T2q, T2u, T2p;
				   {
					E T2w, T2z, T2y, T2A, T2x;
					{
					     ...
					     iio[WS(vs, 1) + WS(is, 7)] = FNMS(TbE, TbC, TbG);
					     rio[WS(vs, 1) + WS(is, 7)] = FMA(TbE, TbF, TbD);
					     TZ = W[0];
					     T12 = W[1];
					...
					}
					{
					     ...
					     iio[WS(vs, 1) + WS(is, 1)] = FNMS(T2y, T2w, T2A);
					     rio[WS(vs, 1) + WS(is, 1)] = FMA(T2y, T2z, T2x);
					     T15 = W[10];
					     T1c = W[11];
					     T1b = T15 * T1a;
					     T1i = T1c * T1a;
				   ...
				   }
				   {
					E TbZ, TbM, TbV, TbY, TbX, Tc0;
					{
					     ...
					     iio[WS(vs, 5) + WS(is, 1)] = FNMS(T2q, T2o, T2u);
					     rio[WS(vs, 5) + WS(is, 1)] = FMA(T2q, T2t, T2p);
					     Tap = W[2];
					     Tas = W[3];
					     TbT = TbP - TbS;
					     TbZ = TbP + TbS;
					     ...
					     TbV = W[2];
					     TbY = W[3];
					     iio[WS(vs, 2) + WS(is, 6)] = FNMS(Tas, Tat, Tar);
					     rio[WS(vs, 2) + WS(is, 6)] = FMA(Tap, Tat, Tau);
					     TbX = TbV * TbW;
					     Tc0 = TbY * TbW;
					}
					{
					     ...
					     Taw = T9d - T9k;
					     TaB = Taz - TaA;
					     iio[WS(vs, 2) + WS(is, 7)] = FNMS(TbY, TbZ, TbX);
					     rio[WS(vs, 2) + WS(is, 7)] = FMA(TbV, TbZ, Tc0);
					     Tav = W[6];
					     Tay = W[7];
					     TaC = Tav * TaB;
					     Tax = Tav * Taw;
					     TbH = W[10];
					     TbO = W[11];
					     iio[WS(vs, 4) + WS(is, 6)] = FNMS(Tay, Taw, TaC);
					     rio[WS(vs, 4) + WS(is, 6)] = FMA(Tay, TaB, Tax);
					     TbN = TbH * TbM;
					     TbU = TbO * TbM;
					}
				   }
			      ...
			      E T3U, T3Z, T74, T77, T9Y, Ta3, T7l, T7e, T8X, T8T, T8W, T8V, T8Y;
			      {
				   E T5y, T5B, T5A, T5C, T5z;
				   {
					E T5Y, T63, T60, T64, T5Z;
					{
					     ...
					     iio[WS(vs, 6) + WS(is, 7)] = FNMS(TbO, TbT, TbN);
					     rio[WS(vs, 6) + WS(is, 7)] = FMA(TbH, TbT, TbU);
					     T2P = W[2];
					     T2S = W[3];
					     T5Y = T4F - T4M;
					     T63 = T61 - T62;
					     ...
					     T5X = W[6];
					     T60 = W[7];
					     iio[WS(vs, 2) + WS(is, 1)] = FNMS(T2S, T2T, T2R);
					     rio[WS(vs, 2) + WS(is, 1)] = FMA(T2P, T2T, T2U);
					     T64 = T5X * T63;
					     T5Z = T5X * T5Y;
					}
					{
					     ...
					     iio[WS(vs, 4) + WS(is, 3)] = FNMS(T60, T5Y, T64);
					     rio[WS(vs, 4) + WS(is, 3)] = FMA(T60, T63, T5Z);
					     T41 = W[0];
					     T44 = W[1];
					     ...
					     T5x = W[0];
					     T5A = W[1];
					     iio[WS(vs, 1) + WS(is, 2)] = FNMS(T44, T42, T46);
					     rio[WS(vs, 1) + WS(is, 2)] = FMA(T44, T45, T43);
					     T5C = T5x * T5B;
					     T5z = T5x * T5y;
					}
				   }
				   {
					E Ta6, Ta9, Ta8, Taa, Ta7;
					{
					     ...
					     iio[WS(vs, 1) + WS(is, 3)] = FNMS(T5A, T5y, T5C);
					     rio[WS(vs, 1) + WS(is, 3)] = FMA(T5A, T5B, T5z);
					     T6T = W[8];
					     T6Y = W[9];
					     ...
					     Ta5 = W[0];
					     Ta8 = W[1];
					     iio[WS(vs, 5) + WS(is, 4)] = FNMS(T6Y, T6W, T72);
					     rio[WS(vs, 5) + WS(is, 4)] = FMA(T6Y, T71, T6X);
					     Taa = Ta5 * Ta9;
					     Ta7 = Ta5 * Ta6;
					}
					{
					     ...
					     T7o = T7d + T7c;
					     T7e = T7c - T7d;
					     iio[WS(vs, 1) + WS(is, 6)] = FNMS(Ta8, Ta6, Taa);
					     rio[WS(vs, 1) + WS(is, 6)] = FMA(Ta8, Ta9, Ta7);
					     T7n = W[2];
					     T7q = W[3];
					     T8R = T8N - T8Q;
					     T8X = T8N + T8Q;
					     ...
					     T8T = W[2];
					     T8W = W[3];
					     iio[WS(vs, 2) + WS(is, 4)] = FNMS(T7q, T7r, T7p);
					     rio[WS(vs, 2) + WS(is, 4)] = FMA(T7n, T7r, T7s);
					     T8V = T8T * T8U;
					     T8Y = T8W * T8U;
					}
				   }
			      }
			      {
				   E T5P, T5D, T5K, T5J, T5Q, Ta0, Ta4, T9Z;
				   {
					E T5V, T5I, T5R, T5U, T5T, T5W;
					{
					     ...
					     T2W = T1D - T1K;
					     T31 = T2Z - T30;
					     iio[WS(vs, 2) + WS(is, 5)] = FNMS(T8W, T8X, T8V);
					     rio[WS(vs, 2) + WS(is, 5)] = FMA(T8T, T8X, T8Y);
					     T2V = W[6];
					     T2Y = W[7];
					     T5P = T5L - T5O;
					     T5V = T5L + T5O;
					     ...
					     T5R = W[2];
					     T5U = W[3];
					     iio[WS(vs, 4) + WS(is, 1)] = FNMS(T2Y, T2W, T32);
					     rio[WS(vs, 4) + WS(is, 1)] = FMA(T2Y, T31, T2X);
					     T5T = T5R * T5S;
					     T5W = T5U * T5S;
					}
					{
					     E T3R, T3W, T40, T3V;
					     iio[WS(vs, 2) + WS(is, 3)] = FNMS(T5U, T5V, T5T);
					     rio[WS(vs, 2) + WS(is, 3)] = FMA(T5R, T5V, T5W);
					     T3R = W[8];
					     T3W = W[9];
					     T40 = T3R * T3Z;
					     T3V = T3R * T3U;
					     T5D = W[10];
					     T5K = W[11];
					     iio[WS(vs, 5) + WS(is, 2)] = FNMS(T3W, T3U, T40);
					     rio[WS(vs, 5) + WS(is, 2)] = FMA(T3W, T3Z, T3V);
					     T5J = T5D * T5I;
					     T5Q = T5K * T5I;
					}
				   }
				   {
					...
					iio[WS(vs, 6) + WS(is, 3)] = FNMS(T5K, T5P, T5J);
					rio[WS(vs, 6) + WS(is, 3)] = FMA(T5D, T5P, T5Q);
					T73 = W[0];
					T76 = W[1];
					T78 = T73 * T77;
					T75 = T73 * T74;
					T9V = W[8];
					Ta0 = W[9];
					iio[WS(vs, 1) + WS(is, 4)] = FNMS(T76, T74, T78);
					rio[WS(vs, 1) + WS(is, 4)] = FMA(T76, T77, T75);
					Ta4 = T9V * Ta3;
					T9Z = T9V * T9Y;
				   }
				   {
					E T79, T7g, T7f, T7m, T8Z;
					iio[WS(vs, 5) + WS(is, 6)] = FNMS(Ta0, T9Y, Ta4);
					rio[WS(vs, 5) + WS(is, 6)] = FMA(Ta0, Ta3, T9Z);
					T79 = W[10];
					T7g = W[11];
					T90 = T7H - T7O;
					T95 = T93 - T94;
					...
					T8Z = W[6];
					T92 = W[7];
					iio[WS(vs, 6) + WS(is, 4)] = FNMS(T7g, T7l, T7f);
					rio[WS(vs, 6) + WS(is, 4)] = FMA(T79, T7l, T7m);
					T96 = T8Z * T95;
					T91 = T8Z * T90;
				   }
			      }
			      ...
			      E T8A, T8D, T8C, T8E, T8B;
			      {
				   E T4s, T4x, T4u, T4y, T4t;
				   {
					E T4p, T4m, T5s, T5w, T5r;
					{
					     ...
					     T4c = T4a - T4b;
					     T4m = T4b + T4a;
					     iio[WS(vs, 4) + WS(is, 5)] = FNMS(T92, T90, T96);
					     rio[WS(vs, 4) + WS(is, 5)] = FMA(T92, T95, T91);
					     T47 = W[10];
					     T4e = W[11];
					     T4d = T47 * T4c;
					     T4k = T4e * T4c;
					     T5n = W[8];
					     T5s = W[9];
					     iio[WS(vs, 6) + WS(is, 2)] = FNMS(T4e, T4j, T4d);
					     rio[WS(vs, 6) + WS(is, 2)] = FMA(T47, T4j, T4k);
					     T5w = T5n * T5v;
					     T5r = T5n * T5q;
					}
					{
					     E T4l, T4o, T4n, T4q, T4r;
					     iio[WS(vs, 5) + WS(is, 3)] = FNMS(T5s, T5q, T5w);
					     rio[WS(vs, 5) + WS(is, 3)] = FMA(T5s, T5v, T5r);
					     T4l = W[2];
					     T4o = W[3];
					     T4s = T39 - T3g;
					     T4x = T4v - T4w;
					     ...
					     T4r = W[6];
					     T4u = W[7];
					     iio[WS(vs, 2) + WS(is, 2)] = FNMS(T4o, T4p, T4n);
					     rio[WS(vs, 2) + WS(is, 2)] = FMA(T4l, T4p, T4q);
					     T4y = T4r * T4x;
					     T4t = T4r * T4s;
					}
				   }
				   {
					E T8F, T8M, T8L, T8S;
					{
					     ...
					     T7u = T6b - T6i;
					     T7z = T7x - T7y;
					     iio[WS(vs, 4) + WS(is, 2)] = FNMS(T4u, T4s, T4y);
					     rio[WS(vs, 4) + WS(is, 2)] = FMA(T4u, T4x, T4t);
					     T7t = W[6];
					     T7w = W[7];
					     T7A = T7t * T7z;
					     T7v = T7t * T7u;
					     T8F = W[10];
					     T8M = W[11];
					     iio[WS(vs, 4) + WS(is, 4)] = FNMS(T7w, T7u, T7A);
					     rio[WS(vs, 4) + WS(is, 4)] = FMA(T7w, T7z, T7v);
					     T8L = T8F * T8K;
					     T8S = T8M * T8K;
					}
					{
					     ...
					     iio[WS(vs, 6) + WS(is, 5)] = FNMS(T8M, T8R, T8L);
					     rio[WS(vs, 6) + WS(is, 5)] = FMA(T8F, T8R, T8S);
					     T8p = W[8];
					     T8u = W[9];
					     T8y = T8p * T8x;
					     T8t = T8p * T8s;
					     T8z = W[0];
					     T8C = W[1];
					     iio[WS(vs, 5) + WS(is, 5)] = FNMS(T8u, T8s, T8y);
					     rio[WS(vs, 5) + WS(is, 5)] = FMA(T8u, T8x, T8t);
					     T8E = T8z * T8D;
					     T8B = T8z * T8A;
					}
				   }
				   ...
				   E T3y, T3J, T3h, T3A, T3z, T3K;
				   {
					E T54, T5f, T4N, T56, T55, T5g;
					{
					     E Tw, TH, Tf, Ty, Tx, TI;
					     {
						  ...
						  iio[WS(vs, 1) + WS(is, 5)] = FNMS(T8C, T8A, T8E);
						  rio[WS(vs, 1) + WS(is, 5)] = FMA(T8C, T8D, T8B);
					     ...
					     iio[WS(vs, 7)] = FNMS(Ty, TH, Tx);
					     {
						  ...
						  T5m = T5k * T5i;
						  T56 = W[13];
						  iio[WS(vs, 3) + WS(is, 3)] = FNMS(T5k, T5l, T5j);
						  T55 = T4N * T54;
						  rio[WS(vs, 3) + WS(is, 3)] = FMA(T5h, T5l, T5m);
					     }
					}
					T5g = T56 * T54;
					{
					     E T22, T2d, T1L, T24, T23, T2e;
					     {
						  ...
						  iio[WS(vs, 7) + WS(is, 3)] = FNMS(T56, T5f, T55);
						  T22 = FNMS(KP707106781, T21, T1Q);
						  T2g = FMA(KP707106781, T21, T1Q);
						  rio[WS(vs, 7) + WS(is, 3)] = FMA(T4N, T5f, T5g);
						  ...
						  T24 = W[13];
						  T23 = T1L * T22;
						  iio[WS(vs, 3) + WS(is, 1)] = FNMS(T2i, T2j, T2h);
						  rio[WS(vs, 3) + WS(is, 1)] = FMA(T2f, T2j, T2k);
					     }
					     T2e = T24 * T22;
					     iio[WS(vs, 7) + WS(is, 1)] = FNMS(T24, T2d, T23);
					     {
						  E T3L, T3P, T3O, T3N, T3Q, T3M;
						  T3M = FMA(KP707106781, T3x, T3m);
						  T3y = FNMS(KP707106781, T3x, T3m);
						  rio[WS(vs, 7) + WS(is, 1)] = FMA(T1L, T2d, T2e);
						  T3L = W[4];
						  ...
						  T3Q = T3O * T3M;
						  T3A = W[13];
						  iio[WS(vs, 3) + WS(is, 2)] = FNMS(T3O, T3P, T3N);
						  T3z = T3h * T3y;
						  rio[WS(vs, 3) + WS(is, 2)] = FMA(T3L, T3P, T3Q);
					     }
					}
				   }
				   T3K = T3A * T3y;
				   {
					E Tb8, Tbj, TaR, Tba, Tb9, Tbk;
					{
					     E T6A, T6L, T6j, T6C, T6B, T6M;
					     {
						  ...
						  iio[WS(vs, 7) + WS(is, 2)] = FNMS(T3A, T3J, T3z);
						  T6A = FNMS(KP707106781, T6z, T6o);
						  T6O = FMA(KP707106781, T6z, T6o);
						  rio[WS(vs, 7) + WS(is, 2)] = FMA(T3h, T3J, T3K);
						  ...
						  T6C = W[13];
						  T6B = T6j * T6A;
						  iio[WS(vs, 3) + WS(is, 4)] = FNMS(T6Q, T6R, T6P);
						  rio[WS(vs, 3) + WS(is, 4)] = FMA(T6N, T6R, T6S);
					     }
					     T6M = T6C * T6A;
					     iio[WS(vs, 7) + WS(is, 4)] = FNMS(T6C, T6L, T6B);
					     {
						  E Tbl, Tbp, Tbo, Tbn, Tbq, Tbm;
						  Tbm = FMA(KP707106781, Tb7, TaW);
						  Tb8 = FNMS(KP707106781, Tb7, TaW);
						  rio[WS(vs, 7) + WS(is, 4)] = FMA(T6j, T6L, T6M);
						  Tbl = W[4];
						  ...
						  Tbq = Tbo * Tbm;
						  Tba = W[13];
						  iio[WS(vs, 3) + WS(is, 7)] = FNMS(Tbo, Tbp, Tbn);
						  Tb9 = TaR * Tb8;
						  rio[WS(vs, 3) + WS(is, 7)] = FMA(Tbl, Tbp, Tbq);
					     }
					}
					Tbk = Tba * Tb8;
					{
					     E T86, T8h, T7P, T88, T87, T8i;
					     {
						  ...
						  iio[WS(vs, 7) + WS(is, 7)] = FNMS(Tba, Tbj, Tb9);
						  T86 = FNMS(KP707106781, T85, T7U);
						  T8k = FMA(KP707106781, T85, T7U);
						  rio[WS(vs, 7) + WS(is, 7)] = FMA(TaR, Tbj, Tbk);
						  ...
						  T88 = W[13];
						  T87 = T7P * T86;
						  iio[WS(vs, 3) + WS(is, 5)] = FNMS(T8m, T8n, T8l);
						  rio[WS(vs, 3) + WS(is, 5)] = FMA(T8j, T8n, T8o);
					     }
					     T8i = T88 * T86;
					     iio[WS(vs, 7) + WS(is, 5)] = FNMS(T88, T8h, T87);
					     {
						  E T9P, T9T, T9S, T9R, T9U, T9Q;
						  T9Q = FMA(KP707106781, T9B, T9q);
						  T9C = FNMS(KP707106781, T9B, T9q);
						  rio[WS(vs, 7) + WS(is, 5)] = FMA(T7P, T8h, T8i);
						  T9P = W[4];
						  ...
						  T9U = T9S * T9Q;
						  T9E = W[13];
						  iio[WS(vs, 3) + WS(is, 6)] = FNMS(T9S, T9T, T9R);
						  T9D = T9l * T9C;
						  rio[WS(vs, 3) + WS(is, 6)] = FMA(T9P, T9T, T9U);
					     }
					}
				   }
			      }
	  ...
	  T9O = T9E * T9C;
	  iio[WS(vs, 7) + WS(is, 6)] = FNMS(T9E, T9N, T9D);
	  rio[WS(vs, 7) + WS(is, 6)] = FMA(T9l, T9N, T9O);
     }
     return W;
}
