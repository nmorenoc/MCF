...
/* Generated on Sat Oct  4 10:35:30 EDT 2008 */

#include "codelet-rdft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_hc2r -fma -reorder-insns -schedule-for-pipeline -compact -variables 4 -pipeline-latency 4 -sign 1 -n 128 -name hc2r_128 -include hc2r.h */
...
static void hc2r_128(const R *ri, const R *ii, R *O, stride ris, stride iis, stride os, INT v, INT ivs, INT ovs)
{
     ...
     for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, O = O + ovs, MAKE_VOLATILE_STRIDE(ris), MAKE_VOLATILE_STRIDE(iis), MAKE_VOLATILE_STRIDE(os)) {
			 ...
			 E Tc8;
			 {
			      E TeO, TaH, TeR, TeL, TeU, TeZ, Tf2, TeX, Tfh, Tfn, Tfo, Tfm;
			      {
				   ...
				   Tfk = TeW + TeV;
				   {
					...
					Tfl = Tfj - Tfk;
					Tfq = Tfk + Tfj;
					O[0] = FMA(KP2_000000000, T24, T13);
					O[WS(os, 64)] = FNMS(KP2_000000000, T24, T13);
					O[WS(os, 96)] = FMA(KP2_000000000, Tfq, Tfp);
					O[WS(os, 32)] = FNMS(KP2_000000000, Tfq, Tfp);
					Tfo = Tfi + Tfl;
					Tfm = Tfi - Tfl;
				   }
			      }
			      {
				   ...
				   O[WS(os, 16)] = FMA(KP1_414213562, Tfm, Tfh);
				   O[WS(os, 80)] = FNMS(KP1_414213562, Tfm, Tfh);
				   O[WS(os, 112)] = FMA(KP1_414213562, Tfo, Tfn);
				   O[WS(os, 48)] = FNMS(KP1_414213562, Tfo, Tfn);
				   ...
				   TeS = TeO - TeR;
				   {
					E TbH, TbK, TaI, TaR;
					{
					     ...
					     TbH = FMA(KP707106781, TbG, TbD);
					     {
						  ...
						  O[WS(os, 88)] = FMA(KP1_847759065, Tfc, Tf9);
						  O[WS(os, 24)] = FNMS(KP1_847759065, Tfc, Tf9);
						  O[WS(os, 120)] = FMA(KP1_847759065, Tfe, Tfd);
						  O[WS(os, 56)] = FNMS(KP1_847759065, Tfe, Tfd);
						  O[WS(os, 104)] = FMA(KP1_847759065, Tf6, Tf5);
						  O[WS(os, 40)] = FNMS(KP1_847759065, Tf6, Tf5);
						  O[WS(os, 8)] = FMA(KP1_847759065, Tf4, TeT);
						  O[WS(os, 72)] = FNMS(KP1_847759065, Tf4, TeT);
						  TbK = TbI + TbJ;
						  Tc5 = TbI - TbJ;
					     }
					}
			      ...
			      E Ten, Teo, Tex, Tef, Tdz, Ter, Teq, TdQ, Tei, Teb, Teg, TdK, Te1, Tey;
			      {
				   E Te7, Tea, TdE, TdJ;
				   {
					...
					Te7 = Te3 + Te6;
					{
					     ...
					     O[WS(os, 82)] = FMA(KP1_546020906, TbU, TbR);
					     O[WS(os, 18)] = FNMS(KP1_546020906, TbU, TbR);
					     O[WS(os, 114)] = FMA(KP1_546020906, TbW, TbV);
					     O[WS(os, 50)] = FNMS(KP1_546020906, TbW, TbV);
					     O[WS(os, 98)] = FMA(KP1_990369453, TbO, TbN);
					     O[WS(os, 34)] = FNMS(KP1_990369453, TbO, TbN);
					     O[WS(os, 2)] = FMA(KP1_990369453, TbM, TaT);
					     O[WS(os, 66)] = FNMS(KP1_990369453, TbM, TaT);
					     Tea = Te8 + Te9;
					     Tev = Te8 - Te9;
					}
				   }
			      ...
			      }
			      {
				   E Tcd, TbZ, Tcg, Tc9, Tce, Tc2;
				   {
					...
					Te2 = FMA(KP707106781, Te1, TdQ);
					{
					     ...
					     O[WS(os, 84)] = FMA(KP1_662939224, Tek, Teh);
					     O[WS(os, 20)] = FNMS(KP1_662939224, Tek, Teh);
					     O[WS(os, 116)] = FMA(KP1_662939224, Tem, Tel);
					     O[WS(os, 52)] = FNMS(KP1_662939224, Tem, Tel);
					     O[WS(os, 100)] = FMA(KP1_961570560, Tee, Ted);
					     O[WS(os, 36)] = FNMS(KP1_961570560, Tee, Ted);
					     O[WS(os, 4)] = FMA(KP1_961570560, Tec, TdL);
					     O[WS(os, 68)] = FNMS(KP1_961570560, Tec, TdL);
					}
				   }
				   ...
				   Tc2 = FNMS(KP668178637, Tc1, Tc0);
				   {
					...
					Tc6 = FNMS(KP923879532, Tc5, Tc4);
					{
					     ...
					     O[WS(os, 90)] = FMA(KP1_913880671, Tci, Tcf);
					     O[WS(os, 26)] = FNMS(KP1_913880671, Tci, Tcf);
					     O[WS(os, 122)] = FMA(KP1_913880671, Tck, Tcj);
					     O[WS(os, 58)] = FNMS(KP1_913880671, Tck, Tcj);
					     O[WS(os, 106)] = FMA(KP1_763842528, Tcc, Tcb);
					     O[WS(os, 42)] = FNMS(KP1_763842528, Tcc, Tcb);
					     O[WS(os, 10)] = FMA(KP1_763842528, Tca, Tc3);
					     O[WS(os, 74)] = FNMS(KP1_763842528, Tca, Tc3);
					}
				   }
			      ...
			      E Tde;
			      {
				   E TcN, TcQ, Tcu, Tcx;
				   {
					...
					TcN = FNMS(KP707106781, TcM, TcL);
					{
					     ...
					     O[WS(os, 92)] = FMA(KP1_961570560, TeI, TeF);
					     O[WS(os, 28)] = FNMS(KP1_961570560, TeI, TeF);
					     O[WS(os, 124)] = FMA(KP1_961570560, TeK, TeJ);
					     O[WS(os, 60)] = FNMS(KP1_961570560, TeK, TeJ);
					     O[WS(os, 108)] = FMA(KP1_662939224, TeC, TeB);
					     O[WS(os, 44)] = FNMS(KP1_662939224, TeC, TeB);
					     O[WS(os, 12)] = FMA(KP1_662939224, TeA, Tet);
					     O[WS(os, 76)] = FNMS(KP1_662939224, TeA, Tet);
					     TcQ = TcO - TcP;
					     Tdb = TcO + TcP;
					}
				   }
			      ...
			      }
			      {
				   E Tdj, Td5, Tdm, Tdf, Tdk, Td8;
				   {
					...
					TcK = FMA(KP923879532, TcJ, TcC);
					{
					     ...
					     O[WS(os, 86)] = FMA(KP1_763842528, Td0, TcX);
					     O[WS(os, 22)] = FNMS(KP1_763842528, Td0, TcX);
					     O[WS(os, 118)] = FMA(KP1_763842528, Td2, Td1);
					     O[WS(os, 54)] = FNMS(KP1_763842528, Td2, Td1);
					     O[WS(os, 102)] = FMA(KP1_913880671, TcU, TcT);
					     O[WS(os, 38)] = FNMS(KP1_913880671, TcU, TcT);
					     O[WS(os, 6)] = FMA(KP1_913880671, TcS, Tcz);
					     O[WS(os, 70)] = FNMS(KP1_913880671, TcS, Tcz);
					}
				   }
					...
					E T5A;
					{
					     E T5N, T5O, T5R, T3w, T3J, T5Q, T5y, T5z;
					     {
						  ...
						  T3w = FMA(KP923879532, T3v, T38);
						  {
						       ...
						       O[WS(os, 94)] = FMA(KP1_990369453, Tdo, Tdl);
						       O[WS(os, 30)] = FNMS(KP1_990369453, Tdo, Tdl);
						       O[WS(os, 126)] = FMA(KP1_990369453, Tdq, Tdp);
						       O[WS(os, 62)] = FNMS(KP1_990369453, Tdq, Tdp);
						       O[WS(os, 110)] = FMA(KP1_546020906, Tdi, Tdh);
						       O[WS(os, 46)] = FNMS(KP1_546020906, Tdi, Tdh);
						       O[WS(os, 14)] = FMA(KP1_546020906, Tdg, Td9);
						       O[WS(os, 78)] = FNMS(KP1_546020906, Tdg, Td9);
					...
					}
					{
					     E T5W, T5I, T5Z, T5J;
					     {
						  ...
						  T5k = FMA(KP980785280, T5j, T4q);
						  {
						       ...
						       O[WS(os, 121)] = FMA(KP1_883088130, T6a, T69);
						       O[WS(os, 57)] = FNMS(KP1_883088130, T6a, T69);
						       O[WS(os, 89)] = FMA(KP1_883088130, T68, T65);
						       O[WS(os, 25)] = FNMS(KP1_883088130, T68, T65);
						       O[WS(os, 1)] = FMA(KP1_997590912, T5C, T3L);
						       O[WS(os, 65)] = FNMS(KP1_997590912, T5C, T3L);
						       O[WS(os, 33)] = FNMS(KP1_997590912, T5E, T5D);
						       O[WS(os, 97)] = FMA(KP1_997590912, T5E, T5D);
						  }
					     }
					     {
						  E T5H, T5K, T5T, T60;
						  ...
						  O[WS(os, 81)] = FMA(KP1_481902250, T5K, T5H);
						  O[WS(os, 17)] = FNMS(KP1_481902250, T5K, T5H);
						  O[WS(os, 9)] = FMA(KP1_807978586, T60, T5T);
						  O[WS(os, 73)] = FNMS(KP1_807978586, T60, T5T);
					     }
					}
				   }
			      }
			      ...
			      E T8B, T8C, T8R, T8S;
			      {
				   ...
				   E T8q;
				   {
					E T8D, T8E, T8H, T8G, T8o, T8p;
					{
					     ...
					     O[WS(os, 105)] = FMA(KP1_807978586, T62, T61);
					     O[WS(os, 41)] = FNMS(KP1_807978586, T62, T61);
					     O[WS(os, 113)] = FMA(KP1_481902250, T5M, T5L);
					     O[WS(os, 49)] = FNMS(KP1_481902250, T5M, T5L);
				   ...
				   }
				   {
					E T8M, T8y, T8P, T8z;
					{
					     ...
					     T8g = FMA(KP831469612, T8f, T80);
					     {
						  ...
						  O[WS(os, 123)] = FMA(KP1_940062506, T90, T8Z);
						  O[WS(os, 59)] = FNMS(KP1_940062506, T90, T8Z);
						  O[WS(os, 91)] = FMA(KP1_940062506, T8Y, T8V);
						  O[WS(os, 27)] = FNMS(KP1_940062506, T8Y, T8V);
						  O[WS(os, 3)] = FMA(KP1_978353019, T8s, T7P);
						  O[WS(os, 67)] = FNMS(KP1_978353019, T8s, T7P);
						  O[WS(os, 35)] = FNMS(KP1_978353019, T8u, T8t);
						  O[WS(os, 99)] = FMA(KP1_978353019, T8u, T8t);
					     }
					}
					{
					     E T8x, T8A, T8J, T8Q;
					     ...
					     O[WS(os, 83)] = FMA(KP1_606415062, T8A, T8x);
					     O[WS(os, 19)] = FNMS(KP1_606415062, T8A, T8x);
					     O[WS(os, 11)] = FMA(KP1_715457220, T8Q, T8J);
					     O[WS(os, 75)] = FNMS(KP1_715457220, T8Q, T8J);
					}
				   }
			      }
			      {
				   E T6R, T6S, T77, T78;
				   {
					...
					E T6G;
					{
					     E T6T, T6U, T6X, T6W, T6E, T6F;
					     {
						  ...
						  O[WS(os, 107)] = FMA(KP1_715457220, T8S, T8R);
						  O[WS(os, 43)] = FNMS(KP1_715457220, T8S, T8R);
						  O[WS(os, 115)] = FMA(KP1_606415062, T8C, T8B);
						  O[WS(os, 51)] = FNMS(KP1_606415062, T8C, T8B);
					...
					}
					{
					     E T72, T6O, T75, T6P;
					     {
						  ...
						  T6A = FMA(KP831469612, T6z, T6s);
						  {
						       ...
						       O[WS(os, 125)] = FMA(KP1_978353019, T7g, T7f);
						       O[WS(os, 61)] = FNMS(KP1_978353019, T7g, T7f);
						       O[WS(os, 93)] = FMA(KP1_978353019, T7e, T7b);
						       O[WS(os, 29)] = FNMS(KP1_978353019, T7e, T7b);
						       O[WS(os, 5)] = FMA(KP1_940062506, T6I, T6p);
						       O[WS(os, 69)] = FNMS(KP1_940062506, T6I, T6p);
						       O[WS(os, 37)] = FNMS(KP1_940062506, T6K, T6J);
						       O[WS(os, 101)] = FMA(KP1_940062506, T6K, T6J);
						  }
					     }
					     {
						  E T6N, T6Q, T6Z, T76;
						  ...
						  O[WS(os, 85)] = FMA(KP1_715457220, T6Q, T6N);
						  O[WS(os, 21)] = FNMS(KP1_715457220, T6Q, T6N);
						  O[WS(os, 13)] = FMA(KP1_606415062, T76, T6Z);
						  O[WS(os, 77)] = FNMS(KP1_606415062, T76, T6Z);
					     }
					}
				   }
				   {
					...
					E T9w;
					{
					     E T9J, T9K, T9N, T9M, T9u, T9v;
					     {
						  ...
						  O[WS(os, 109)] = FMA(KP1_606415062, T78, T77);
						  O[WS(os, 45)] = FNMS(KP1_606415062, T78, T77);
						  O[WS(os, 117)] = FMA(KP1_715457220, T6S, T6R);
						  O[WS(os, 53)] = FNMS(KP1_715457220, T6S, T6R);
					...
					}
					{
					     E T9S, T9E, T9V, T9F;
					     {
						  ...
						  T9q = FNMS(KP980785280, T9p, T9i);
						  {
						       ...
						       O[WS(os, 127)] = FMA(KP1_997590912, Ta6, Ta5);
						       O[WS(os, 63)] = FNMS(KP1_997590912, Ta6, Ta5);
						       O[WS(os, 95)] = FMA(KP1_997590912, Ta4, Ta1);
						       O[WS(os, 31)] = FNMS(KP1_997590912, Ta4, Ta1);
						       O[WS(os, 7)] = FMA(KP1_883088130, T9y, T9f);
						       O[WS(os, 71)] = FNMS(KP1_883088130, T9y, T9f);
						       O[WS(os, 39)] = FNMS(KP1_883088130, T9A, T9z);
						       O[WS(os, 103)] = FMA(KP1_883088130, T9A, T9z);
						  }
					     }
					     {
						  E T9D, T9G, T9P, T9W;
						  ...
						  O[WS(os, 87)] = FMA(KP1_807978586, T9G, T9D);
						  O[WS(os, 23)] = FNMS(KP1_807978586, T9G, T9D);
						  O[WS(os, 15)] = FMA(KP1_481902250, T9W, T9P);
						  O[WS(os, 79)] = FNMS(KP1_481902250, T9W, T9P);
					     }
					}
				   }
			      }
	  ...
	  O[WS(os, 111)] = FMA(KP1_481902250, T9Y, T9X);
	  O[WS(os, 47)] = FNMS(KP1_481902250, T9Y, T9X);
	  O[WS(os, 119)] = FMA(KP1_807978586, T9I, T9H);
	  O[WS(os, 55)] = FNMS(KP1_807978586, T9I, T9H);
     }
}

static const khc2r_desc desc = { 128, "hc2r_128", {416, 0, 540, 0}, &GENUS, 0, 0, 0, 0, 0 };

void X(codelet_hc2r_128) (planner *p) {
     X(khc2r_register) (p, hc2r_128, &desc);
}

#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_hc2r -compact -variables 4 -pipeline-latency 4 -sign 1 -n 128 -name hc2r_128 -include hc2r.h */
...
static const khc2r_desc desc = { 128, "hc2r_128", {812, 198, 144, 0}, &GENUS, 0, 0, 0, 0, 0 };
