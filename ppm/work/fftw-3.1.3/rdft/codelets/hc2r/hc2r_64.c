...
/* Generated on Sat Oct  4 10:35:29 EDT 2008 */

#include "codelet-rdft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_hc2r -fma -reorder-insns -schedule-for-pipeline -compact -variables 4 -pipeline-latency 4 -sign 1 -n 64 -name hc2r_64 -include hc2r.h */
...
static void hc2r_64(const R *ri, const R *ii, R *O, stride ris, stride iis, stride os, INT v, INT ivs, INT ovs)
{
     ...
     for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, O = O + ovs, MAKE_VOLATILE_STRIDE(ris), MAKE_VOLATILE_STRIDE(iis), MAKE_VOLATILE_STRIDE(os)) {
	       ...
	       }
	       {
		    E T3K, T3B, T5u, T5r, T5d, T5g;
		    {
			 ...
			 T3B = FNMS(KP414213562, T3A, T3z);
			 {
			      ...
			      O[WS(os, 16)] = FNMS(KP2_000000000, T6m, T6l);
			      O[WS(os, 48)] = FMA(KP2_000000000, T6m, T6l);
			      O[0] = FMA(KP2_000000000, T12, Tx);
			      O[WS(os, 32)] = FNMS(KP2_000000000, T12, Tx);
			      T67 = T5Q - T5T;
			      T5U = T5Q + T5T;
			 }
			 {
			      ...
			      O[WS(os, 28)] = FNMS(KP1_847759065, T6a, T69);
			      O[WS(os, 60)] = FMA(KP1_847759065, T6a, T69);
			      O[WS(os, 44)] = FMA(KP1_847759065, T68, T65);
			      O[WS(os, 12)] = FNMS(KP1_847759065, T68, T65);
			      {
				   E T61, T5P, T6k, T6i;
				   T6k = T6e + T6h;
				   T6i = T6e - T6h;
				   ...
				   O[WS(os, 24)] = FNMS(KP1_414213562, T6k, T6j);
				   O[WS(os, 56)] = FMA(KP1_414213562, T6k, T6j);
				   O[WS(os, 8)] = FMA(KP1_414213562, T6i, T6d);
				   O[WS(os, 40)] = FNMS(KP1_414213562, T6i, T6d);
				   {
					E T5b, T4v, T5f, T4Y, T5e, T57, T4G, T5c;
					{
					     ...
					     O[WS(os, 20)] = FNMS(KP1_847759065, T62, T61);
					     O[WS(os, 52)] = FMA(KP1_847759065, T62, T61);
					     O[WS(os, 4)] = FMA(KP1_847759065, T60, T5P);
					     O[WS(os, 36)] = FNMS(KP1_847759065, T60, T5P);
					...
					}
					{
					     ...
					     O[WS(os, 2)] = FMA(KP1_961570560, T58, T4H);
					     O[WS(os, 34)] = FNMS(KP1_961570560, T58, T4H);
					     O[WS(os, 58)] = FMA(KP1_662939224, T5i, T5h);
					     O[WS(os, 26)] = FNMS(KP1_662939224, T5i, T5h);
					     O[WS(os, 50)] = FMA(KP1_961570560, T5a, T59);
					     O[WS(os, 18)] = FNMS(KP1_961570560, T5a, T59);
					}
				   }
			      }
			 }
		    }
		    {
			 ...
			 E T5E;
			 {
			      ...
			      O[WS(os, 42)] = FMA(KP1_662939224, T5g, T5d);
			      O[WS(os, 10)] = FNMS(KP1_662939224, T5g, T5d);
			      ...
			      T5A = FMA(KP414213562, T5m, T5n);
			      {
				   ...
				   O[WS(os, 6)] = FMA(KP1_662939224, T5w, T5p);
				   O[WS(os, 38)] = FNMS(KP1_662939224, T5w, T5p);
				   O[WS(os, 62)] = FMA(KP1_961570560, T5G, T5F);
				   O[WS(os, 30)] = FNMS(KP1_961570560, T5G, T5F);
				   O[WS(os, 54)] = FMA(KP1_662939224, T5y, T5x);
				   O[WS(os, 22)] = FNMS(KP1_662939224, T5y, T5x);
			      }
			 }
			 {
			      ...
			      O[WS(os, 46)] = FMA(KP1_961570560, T5E, T5B);
			      O[WS(os, 14)] = FNMS(KP1_961570560, T5E, T5B);
			      {
				   E T3q, T3t, T3y, T3F;
			 ...
			 }
			 {
			      E T2X, T2W, T30, T34, T33, T2P, T2u, T31, T2J, T1P, T2R, T2N, T2O, T2H;
			      {
				   ...
				   T1n = FMA(KP1_847759065, T1m, T1b);
				   {
					...
					O[WS(os, 43)] = FMA(KP1_763842528, T3W, T3T);
					O[WS(os, 11)] = FNMS(KP1_763842528, T3W, T3T);
					O[WS(os, 59)] = FMA(KP1_763842528, T3Y, T3X);
					O[WS(os, 27)] = FNMS(KP1_763842528, T3Y, T3X);
					O[WS(os, 51)] = FMA(KP1_913880671, T3Q, T3P);
					O[WS(os, 19)] = FNMS(KP1_913880671, T3Q, T3P);
					O[WS(os, 3)] = FMA(KP1_913880671, T3O, T3v);
					O[WS(os, 35)] = FNMS(KP1_913880671, T3O, T3v);
				   }
				   {
					E T1E, T1N, T26, T2t;
			      ...
			      }
			      {
				   E T4j, T48, T4d, T45, T4l, T4h, T4i, T4b;
				   {
					...
					T41 = FNMS(KP1_847759065, T40, T3Z);
					{
					     ...
					     O[WS(os, 41)] = FMA(KP1_546020906, T2Q, T2N);
					     O[WS(os, 9)] = FNMS(KP1_546020906, T2Q, T2N);
					     O[WS(os, 57)] = FMA(KP1_546020906, T2S, T2R);
					     O[WS(os, 25)] = FNMS(KP1_546020906, T2S, T2R);
					     O[WS(os, 49)] = FMA(KP1_990369453, T2K, T2J);
					     O[WS(os, 17)] = FNMS(KP1_990369453, T2K, T2J);
					     O[WS(os, 1)] = FMA(KP1_990369453, T2I, T1P);
					     O[WS(os, 33)] = FNMS(KP1_990369453, T2I, T1P);
					}
				   ...
				   }
				   {
					...
					T2V = FNMS(KP1_847759065, T2U, T2T);
					{
					     ...
					     O[WS(os, 47)] = FMA(KP1_990369453, T4k, T4h);
					     O[WS(os, 15)] = FNMS(KP1_990369453, T4k, T4h);
					     O[WS(os, 63)] = FMA(KP1_990369453, T4m, T4l);
					     O[WS(os, 31)] = FNMS(KP1_990369453, T4m, T4l);
					     O[WS(os, 55)] = FMA(KP1_546020906, T4e, T4d);
					     O[WS(os, 23)] = FNMS(KP1_546020906, T4e, T4d);
					     O[WS(os, 7)] = FMA(KP1_546020906, T4c, T45);
					     O[WS(os, 39)] = FNMS(KP1_546020906, T4c, T45);
					}
	  ...
	  }
	  {
	       ...
	       O[WS(os, 45)] = FMA(KP1_913880671, T3e, T3b);
	       O[WS(os, 13)] = FNMS(KP1_913880671, T3e, T3b);
	       O[WS(os, 61)] = FMA(KP1_913880671, T3g, T3f);
	       O[WS(os, 29)] = FNMS(KP1_913880671, T3g, T3f);
	       O[WS(os, 53)] = FMA(KP1_763842528, T38, T37);
	       O[WS(os, 21)] = FNMS(KP1_763842528, T38, T37);
	       O[WS(os, 5)] = FMA(KP1_763842528, T36, T2Z);
	       O[WS(os, 37)] = FNMS(KP1_763842528, T36, T2Z);
	  }
     }
}

static const khc2r_desc desc = { 64, "hc2r_64", {178, 0, 216, 0}, &GENUS, 0, 0, 0, 0, 0 };

void X(codelet_hc2r_64) (planner *p) {
     X(khc2r_register) (p, hc2r_64, &desc);
}

#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_hc2r -compact -variables 4 -pipeline-latency 4 -sign 1 -n 64 -name hc2r_64 -include hc2r.h */
...
static const khc2r_desc desc = { 64, "hc2r_64", {342, 82, 52, 0}, &GENUS, 0, 0, 0, 0, 0 };
