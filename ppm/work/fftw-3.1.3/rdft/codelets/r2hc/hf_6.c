	  ...
	  E TY, TU, T10, TZ;
	  {
	       ...
	       }
	       {
		    ...
		    TY = TW + TX;
		    {
			 ...
			 rio[WS(ios, 5)] = FMS(KP866025403, T14, T13);
			 iio[-WS(ios, 1)] = FMA(KP866025403, T14, T13);
			 TE = FNMS(KP500000000, TD, TA);
			 iio[-WS(ios, 5)] = FNMS(KP866025403, TT, TQ);
			 rio[WS(ios, 1)] = FMA(KP866025403, TT, TQ);
			 rio[0] = TA + TD;
			 iio[-WS(ios, 4)] = FMA(KP866025403, TP, TE);
			 rio[WS(ios, 2)] = FNMS(KP866025403, TP, TE);
		    }
	       }
	  }
	  iio[0] = TU + TY;
	  TZ = FNMS(KP500000000, TU, TY);
	  rio[WS(ios, 4)] = FMS(KP866025403, T10, TZ);
	  iio[-WS(ios, 2)] = FMA(KP866025403, T10, TZ);
     }
     return W;
}
...
static const hc2hc_desc desc = { 6, "hf_6", twinstr, &GENUS, {24, 10, 22, 0}, 0, 0, 0 };
...
static const hc2hc_desc desc = { 6, "hf_6", twinstr, &GENUS, {32, 14, 14, 0}, 0, 0, 0 };
