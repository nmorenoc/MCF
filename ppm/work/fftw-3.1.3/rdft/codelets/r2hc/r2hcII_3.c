...
/* Generated on Sat Oct  4 10:31:03 EDT 2008 */

#include "codelet-rdft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_r2hc -fma -reorder-insns -schedule-for-pipeline -compact -variables 4 -pipeline-latency 4 -n 3 -name r2hcII_3 -dft-II -include r2hcII.h */
...
static void r2hcII_3(const R *I, R *ro, R *io, stride is, stride ros, stride ios, INT v, INT ivs, INT ovs)
{
     ...
     for (i = v; i > 0; i = i - 1, I = I + ivs, ro = ro + ovs, io = io + ovs, MAKE_VOLATILE_STRIDE(is), MAKE_VOLATILE_STRIDE(ros), MAKE_VOLATILE_STRIDE(ios)) {
	  ...
	  T1 = I[WS(is, 1)];
	  T2 = I[WS(is, 2)];
	  io[0] = -(KP866025403 * (T1 + T2));
	  T4 = T2 - T1;
	  ro[WS(ros, 1)] = T3 + T4;
	  ro[0] = FNMS(KP500000000, T4, T3);
     }
}
...
/* Generated by: ../../../genfft/gen_r2hc -compact -variables 4 -pipeline-latency 4 -n 3 -name r2hcII_3 -dft-II -include r2hcII.h */
