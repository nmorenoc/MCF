...
/* Generated by: ../../../genfft/gen_r2hc -fma -reorder-insns -schedule-for-pipeline -compact -variables 4 -pipeline-latency 4 -n 9 -name r2hc_9 -include r2hc.h */
...
static void r2hc_9(const R *I, R *ro, R *io, stride is, stride ros, stride ios, INT v, INT ivs, INT ovs)
{
     ...
     for (i = v; i > 0; i = i - 1, I = I + ivs, ro = ro + ovs, io = io + ovs, MAKE_VOLATILE_STRIDE(is), MAKE_VOLATILE_STRIDE(ros), MAKE_VOLATILE_STRIDE(ios)) {
			 ...
			 Th = FNMS(KP500000000, Te, Tb);
			 {
			      ...
			      Tt = FMA(KP394930843, Th, To);
			      {
				   ...
				   Tv = FNMS(KP939692620, Tu, Tt);
				   {
					...
					io[WS(ios, 2)] = KP984807753 * (FNMS(KP879385241, Tv, Tl));
					io[WS(ios, 1)] = -(KP984807753 * (FNMS(KP879385241, To, Tn)));
					TC = FMA(KP666666666, Tn, TB);
					Tr = FNMS(KP347296355, Tq, Tk);
					io[WS(ios, 4)] = KP866025403 * (FMA(KP852868531, TC, To));
	  ...
	  ro[WS(ros, 1)] = FMA(KP852868531, Tz, Tp);
	  TA = FNMS(KP500000000, Tz, Tw);
	  ro[WS(ros, 2)] = FNMS(KP939692620, Ts, Tp);
	  ro[WS(ros, 4)] = FMA(KP852868531, TA, Tp);
     }
}

static const kr2hc_desc desc = { 9, "r2hc_9", {12, 4, 26, 0}, &GENUS, 0, 0, 0, 0, 0 };
...
/* Generated by: ../../../genfft/gen_r2hc -compact -variables 4 -pipeline-latency 4 -n 9 -name r2hc_9 -include r2hc.h */
