...
/* Generated on Sat Oct  4 10:30:57 EDT 2008 */
...
static const R *hf_32(R *rio, R *iio, const R *W, stride ios, INT m, INT dist)
{
     ...
     for (i = m - 2; i > 0; i = i - 2, rio = rio + dist, iio = iio - dist, W = W + 62, MAKE_VOLATILE_STRIDE(ios)) {
	  E T90, T8Z;
	  {
	       ...
	       E T60, T4l, T4v, T65, T6X, T7I, T29, T70, T68, T4S, T4T, T4C, T7J, T73, T6Y;
	       E T2A, T4U, T4J, T5s, T5b, T7e, T7O, T5i, T5t, T3t, T76, T54, T6c, T79, T7N;
	       E T32, T7b, T6f, T5r, T8q, T8p;
	       {
		    E T3X, T1d, T44, T6J, T11, T3T, T3V, T17, T4I, T4D;
		    {
		    ...
		    {
			 E T4y, T2f, T4H, T2y, T2o, T2r, T2q, T4A, T2l, T4E, T2p;
			 {
			      E T2u, T2x, T2w, T4G, T2v;
			      {
				   E T2b, T2e, T2a, T2d, T4x, T2c, T2t;
				   T2b = rio[WS(ios, 5)];
				   T2e = iio[-WS(ios, 26)];
				   T2a = W[8];
				   T2d = W[9];
			 ...
			 {
			      E T4B, T71, T2m, T4w, T4F, T2s, T72, T2z;
			      T4B = T4y - T4A;
			      T71 = T4y + T4A;
			      T2m = T2f + T2l;
			      T4w = T2f - T2l;
		    ...
		    {
			 E T5g, T3r, T5a, T7c, T3f, T55, T5e, T3l;
			 {
			      E T57, T38, T3h, T3k, T59, T3e, T3g, T3j, T5d, T3i;
			      {
				   E T3n, T3q, T3m, T3p;
				   {
					E T34, T37, T36, T56, T35, T33;
					T34 = rio[WS(ios, 3)];
					T37 = iio[-WS(ios, 28)];
					T33 = W[4];
					T4U = T4D + T4I;
				   ...
				   {
					E T3a, T3d, T3c, T58, T3b, T5f, T3o, T39;
					T3a = rio[WS(ios, 19)];
					T3d = iio[-WS(ios, 12)];
					T5f = T3m * T3q;
					T3o = T3m * T3n;
	       ...
	       {
		    E T6E, T8j, T6H, T8k, T7S, T8i, T8h, T7V;
		    {
			 E T7P, T7C, TO, T80, T7Z, T8e, T89, T8d, T1H, T7M, T8b, T3v, T7T, T7L;
			 {
			      E T7K, T82, T88, T7H, T2B, T3u;
			      {
				   E Tm, TN, T7X, T7Y;
				   T6E = T8 - Tl;
				   Tm = T8 + Tl;
			 ...
			 {
			      E T7W, T7U, T7Q, T7F, T8a, T8c, T81, T1I;
			      T7W = TO - T1H;
			      T1I = TO + T1H;
			      T7U = T7M + T7P;
			      T7Q = T7M - T7P;
			      ...
			      T8c = T89 - T81;
			      {
				   ...
				   T7G = T7C + T7F;
				   iio[0] = T80 + T8a;
				   rio[WS(ios, 16)] = T80 - T8a;
				   rio[WS(ios, 8)] = T7W + T7Z;
				   iio[-WS(ios, 24)] = T7W - T7Z;
				   iio[-WS(ios, 8)] = T8b + T8c;
				   rio[WS(ios, 24)] = T8b - T8c;
				   T7R = T7L + T7Q;
				   T8i = T7Q - T7L;
				   T8h = T8e - T8d;
				   T8f = T8d + T8e;
				   T8g = T7T + T7U;
				   T7V = T7T - T7U;
				   rio[WS(ios, 4)] = FMA(KP707106781, T7R, T7G);
				   iio[-WS(ios, 20)] = FNMS(KP707106781, T7R, T7G);
				   iio[-WS(ios, 4)] = FMA(KP707106781, T8g, T8f);
				   rio[WS(ios, 20)] = FMS(KP707106781, T8g, T8f);
			      }
			 }
		    }
		    {
			 E T7f, T7a, T7m, T6I, T7A, T7w, T7s, T8r, T8l, T8m, T6T, T7r, T7j, T75, T8s;
			 E T7p;
			 {
			      E T7n, T6N, T6S, T7o, T7u, T7v, T6Z, T74;
			      rio[WS(ios, 12)] = FMA(KP707106781, T7V, T7S);
			      iio[-WS(ios, 28)] = FNMS(KP707106781, T7V, T7S);
			      iio[-WS(ios, 12)] = FMA(KP707106781, T8i, T8h);
			      rio[WS(ios, 28)] = FMS(KP707106781, T8i, T8h);
			      T7f = T7b - T7e;
			      T7u = T7b + T7e;
			      T7v = T79 + T76;
			      T7a = T76 - T79;
			 ...
			 }
			 {
			      E T7z, T7t, T8v, T8w;
			      {
				   E T7i, T6U, T7k, T7g, T8t, T8u, T7l, T7h;
				   ...
				   T8w = T7g - T75;
				   T7h = T75 + T7g;
				   iio[-WS(ios, 6)] = FMA(KP923879532, T8u, T8t);
				   rio[WS(ios, 22)] = FMS(KP923879532, T8u, T8t);
				   rio[WS(ios, 6)] = FMA(KP923879532, T7h, T6U);
				   iio[-WS(ios, 22)] = FNMS(KP923879532, T7h, T6U);
				   iio[-WS(ios, 30)] = FMA(KP923879532, T7l, T7i);
				   rio[WS(ios, 14)] = FNMS(KP923879532, T7l, T7i);
			      }
			      {
				   E T7y, T8n, T8o, T7B, T7q, T7x;
				   ...
				   iio[-WS(ios, 14)] = FMA(KP923879532, T8w, T8v);
				   rio[WS(ios, 30)] = FMS(KP923879532, T8w, T8v);
				   rio[WS(ios, 2)] = FMA(KP923879532, T7x, T7q);
				   iio[-WS(ios, 18)] = FNMS(KP923879532, T7x, T7q);
				   T8o = T7z + T7A;
				   T7B = T7z - T7A;
				   iio[-WS(ios, 2)] = FMA(KP923879532, T8o, T8n);
				   rio[WS(ios, 18)] = FMS(KP923879532, T8o, T8n);
				   rio[WS(ios, 10)] = FMA(KP923879532, T7B, T7y);
				   iio[-WS(ios, 26)] = FNMS(KP923879532, T7B, T7y);
			      }
			 }
		    }
	       }
	       {
		    ...
		    {
			 E T5C, T3S, T8I, T4n, T8H, T8B, T8C, T5F, T4L, T5H, T5M, T5Q, T5A, T5w, T4V;
			 {
			      ...
			      iio[-WS(ios, 10)] = FMA(KP923879532, T8q, T8p);
			      rio[WS(ios, 26)] = FMS(KP923879532, T8q, T8p);
			      ...
			      T4W = FMA(KP707106781, T4V, T4S);
			      {
				   E T5O, T8L, T8M, T5R;
				   {
					...
					T8L = FNMS(KP923879532, T8I, T8H);
					{
					     ...
					     T8G = T5w - T4X;
					     T5x = T4X + T5w;
					     iio[-WS(ios, 29)] = FMA(KP831469612, T5N, T5G);
					     rio[WS(ios, 13)] = FNMS(KP831469612, T5N, T5G);
					     rio[WS(ios, 9)] = FMA(KP980785280, T5B, T5y);
					     iio[-WS(ios, 25)] = FNMS(KP980785280, T5B, T5y);
					     iio[-WS(ios, 1)] = FMA(KP980785280, T8E, T8D);
					     rio[WS(ios, 17)] = FMS(KP980785280, T8E, T8D);
					     iio[-WS(ios, 9)] = FMA(KP980785280, T8G, T8F);
					     rio[WS(ios, 25)] = FMS(KP980785280, T8G, T8F);
					     rio[WS(ios, 1)] = FMA(KP980785280, T5x, T4o);
					     iio[-WS(ios, 17)] = FNMS(KP980785280, T5x, T4o);
					     T8M = T5P + T5Q;
					     T5R = T5P - T5Q;
					}
				   }
				   iio[-WS(ios, 13)] = FNMS(KP831469612, T8M, T8L);
				   rio[WS(ios, 29)] = -(FMA(KP831469612, T8M, T8L));
				   rio[WS(ios, 5)] = FMA(KP831469612, T5R, T5O);
				   iio[-WS(ios, 21)] = FNMS(KP831469612, T5R, T5O);
			      }
			 }
		    }
		    {
			 E T6o, T5W, T8W, T63, T8V, T8P, T8Q, T6r, T67, T6u, T6y, T6C, T6m, T6i;
			 {
			      ...
			      iio[-WS(ios, 5)] = FMA(KP831469612, T8K, T8J);
			      rio[WS(ios, 21)] = FMS(KP831469612, T8K, T8J);
			      ...
			      T6a = FNMS(KP707106781, T69, T68);
			      {
				   E T6A, T8X, T8Y, T6D;
				   {
					...
					T8X = FNMS(KP923879532, T8W, T8V);
					{
					     ...
					     T8U = T6i - T6b;
					     T6j = T6b + T6i;
					     rio[WS(ios, 7)] = FMA(KP980785280, T6z, T6s);
					     iio[-WS(ios, 23)] = FNMS(KP980785280, T6z, T6s);
					     rio[WS(ios, 11)] = FMA(KP831469612, T6n, T6k);
					     iio[-WS(ios, 27)] = FNMS(KP831469612, T6n, T6k);
					     iio[-WS(ios, 3)] = FMA(KP831469612, T8S, T8R);
					     rio[WS(ios, 19)] = FMS(KP831469612, T8S, T8R);
					     iio[-WS(ios, 11)] = FMA(KP831469612, T8U, T8T);
					     rio[WS(ios, 27)] = FMS(KP831469612, T8U, T8T);
					     rio[WS(ios, 3)] = FMA(KP831469612, T6j, T64);
					     iio[-WS(ios, 19)] = FNMS(KP831469612, T6j, T64);
					     T8Y = T6C - T6B;
					     T6D = T6B + T6C;
					}
				   }
				   iio[-WS(ios, 7)] = FMA(KP980785280, T8Y, T8X);
				   rio[WS(ios, 23)] = FMS(KP980785280, T8Y, T8X);
				   iio[-WS(ios, 31)] = FMA(KP980785280, T6D, T6A);
				   rio[WS(ios, 15)] = FNMS(KP980785280, T6D, T6A);
			      }
			 }
		    }
	       }
	  }
	  iio[-WS(ios, 15)] = FMA(KP980785280, T90, T8Z);
	  rio[WS(ios, 31)] = FMS(KP980785280, T90, T8Z);
     }
     return W;
}
...
static const hc2hc_desc desc = { 32, "hf_32", twinstr, &GENUS, {236, 62, 198, 0}, 0, 0, 0 };
...
static const hc2hc_desc desc = { 32, "hf_32", twinstr, &GENUS, {340, 114, 94, 0}, 0, 0, 0 };
