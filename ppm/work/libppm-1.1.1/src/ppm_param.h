      ...
      !  sending ghost values back to their host processor is ppm_param_map_ghost_put.
      !
      !  Revision 1.12  2004/02/18 14:30:54  walther
      !  Renamed parameters: ppm_param_map_update is now ppm_param_map_partial,
      !  ppm_param_map_ghost is used in both the field and particle ghost mapping
      !  and refers to the ghost VALUE; therefore I added the ppm_param_map_ghostpart
