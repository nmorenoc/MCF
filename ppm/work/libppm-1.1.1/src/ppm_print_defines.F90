...
#include "ppm_define.h"
      ...
      IF (ppm_debug .GT. 0) THEN
          CALL ppm_write(ppm_rank,'ppm_print_defines','USE_MPI defined',info)
      ENDIF
      CALL ppm_log('ppm_print_defines','USE_MPI defined',info)
#endif
#ifdef __Linux
      IF (ppm_debug .GT. 0) THEN
...
#ifdef HAVE_LIBMETIS
      IF (ppm_debug .GT. 0) THEN
          CALL ppm_write(ppm_rank,'ppm_print_defines','HAVE_LIBMETIS defined',info)
      ENDIF
      CALL ppm_log('ppm_print_defines','HAVE_LIBMETIS defined',info)
#endif
#ifdef HAVE_LIBFFTW3
      IF (ppm_debug .GT. 0) THEN
          CALL ppm_write(ppm_rank,'ppm_print_defines','HAVE_LIBFFTW3 defined',info)
      ENDIF
      CALL ppm_log('ppm_print_defines','HAVE_LIBFFTW3 defined',info)
#endif
#ifdef __HYPRE
      IF (ppm_debug .GT. 0) THEN
